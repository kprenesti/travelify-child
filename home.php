...
<section class="about">
  ...
  <div class="about floater clearfix">
    <div class="blog-style">
      ...
      <?php endwhile; endif; wp_reset_postdata(); ?>
      <a class="readmore rightF clearfix" href="<?php echo home_url(); ?>/travel-adventures">See All Posts</a>
    </div>
    <div class="connect blog-style">
    ...
    <ul>
      ...
      <li><strong>Knowledge: </strong> Don't get stuck staying in a hotel in the middle of nowhere.  A travel agent has first-hand knowledge of the places you'll visit, so you're always assured to get the most bang for your buck in a prime location.</li>
  ...
  <div class="services-list">
      ...
      <div class="service floater clearfix">
        ...
        <div class="service-info">
          ...
          <p>Our dedication to travel leads to your dream vacation.  Wherever you want to go, however you want to get there, Alpha J. Travel can find the perfect accommodations and tours for your travel needs. <a style="color:#FBFBCA" href="<?php echo home_url(); ?>/about-us#fit">Read more</a></p>
        </div>
