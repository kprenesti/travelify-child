...
<div class="page-intro">  
  ...
  <div class="slider-wrap">
    <?php echo do_shortcode('[URIS id=329]'); ?>
  </div>  
</div>
  <hr>
  <section class="wrap-left floater clearfix">
    ...
    <figure class="country-highlight">
      ...
      <figcaption>
        <h3>Dubai</h3>
        <p>Glitzy Dubai is the United Arab Emirates' vacation hot spot. This city of high-rises and shopping malls has transformed itself from a desert outpost to a destination du-jour, where people flock for sales bargains, sunshine and family fun. Dubai is famous for sightseeing attractions such as the Burj Khalifa (the world's tallest building) and shopping malls that come complete with mammoth aquariums and indoor ski slopes.</p>
